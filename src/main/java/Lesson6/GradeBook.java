...
public class GradeBook {
    ...
    private final int numberOfStudents; // Same as studentAverage.length.
    private final int numberOfQuizzes; // Same as quizeAverage.length.
    ...
    private void fillStudentAverage() {
        ...
        for (int studentNumber = 1;
             studentNumber <= numberOfStudents; studentNumber++) {//Process one studentNumber:
            double sum = 0;
            for (int quizNumber = 1;
                 quizNumber <= numberOfQuizzes; quizNumber++)
    ...
    private void fillQuizAverage() {
        ...
        for (int quizNumber = 1; quizNumber <= numberOfQuizzes; quizNumber++) {//Process one quiz (for all students):
            double sum = 0;
            for (int studentNumber = 1;
                 studentNumber <= numberOfStudents; studentNumber++)
                sum = sum + grade[studentNumber - 1][quizNumber - 1];
    ...
    public void display() {
        for (int studentNumber = 1;
             studentNumber <= numberOfStudents; studentNumber++) {//Display for one studentNumber:
